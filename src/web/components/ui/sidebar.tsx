    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-[min(18rem,88vw)] bg-sidebar p-0 pt-[var(--safe-t)] pb-[env(safe-area-inset-bottom)] text-sidebar-foreground"
          style={
            {
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>导航索引</SheetTitle>
            <SheetDescription>选择导航项目以切换页面。</SheetDescription>
          </SheetHeader>
...
function SidebarContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'scrollbar-safe flex min-h-0 flex-1 flex-col gap-0 overflow-x-hidden overflow-y-auto overscroll-contain group-data-[collapsible=icon]:overflow-hidden',
        className,
      )}
      {...props}
    />
